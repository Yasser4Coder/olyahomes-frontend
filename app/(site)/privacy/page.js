...
export const metadata = {
  ...
  description: `How ${APP_DISPLAY_NAME} collects, uses, and protects your personal information.`,
};
...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      <PageHeading
        title="Privacy policy"
        subtitle={`How we handle personal information when you use ${APP_DISPLAY_NAME}.`}
      />
      ...
      <div className="space-y-10">
        <p className="text-sm leading-relaxed text-foreground/80">
          {APP_DISPLAY_NAME} (“we”, “us”, “our”) respects your privacy and is
