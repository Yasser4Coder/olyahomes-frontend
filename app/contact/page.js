...
export const metadata = {
  title: "Contact",
  description:
    "Contact Olyahomes—offices, guest support, and hosting inquiries. Send us a message or find directions.",
};
...
const offices = [
  {
    ...
    lines: ["Olyahomes Guest Care", "Business Bay, Dubai", "United Arab Emirates"],
    mapsUrl: "https://maps.google.com/?q=Dubai+Business+Bay",
  },
  {
    city: "Abu Dhabi",
    country: "United Arab Emirates",
    lines: ["Olyahomes", "Al Maryah Island", "Abu Dhabi, UAE"],
      ...
      <section className="relative overflow-hidden pb-8 pt-10 sm:pb-10 sm:pt-12">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-10 lg:px-14">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-foreground/60">
            Questions about a listing, a booking, or hosting with Olyahomes? Reach the right team—we
          ...
          <div className="lg:-mt-8">
            <div className="rounded-3xl border border-secondary/12 bg-white p-6 shadow-[0_28px_64px_-36px_rgba(44,36,25,0.55)] sm:p-8">
              <h2 className="font-hero-serif text-2xl font-semibold tracking-tight text-foreground sm:text-[1.65rem]">
                Let&apos;s talk about your stay or listing
              </h2>
              <p className="mt-2 text-sm text-foreground/60">
                Tell us what you need—guest support, hosting, or partnerships. Wire this form to
                your API when ready.
              </p>
              ...
              <form className="mt-8 space-y-4">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div>
                    <label htmlFor="contact-start" className="block text-sm font-medium text-foreground">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="15k+">AED 15,000+</option>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    name="message"
                    rows={5}
                    placeholder="Listing link, dates, or how we can help…"
                ...
                <button
                  type="button"
                  className="w-full rounded-2xl bg-zinc-900 py-3.5 text-sm font-semibold text-white transition hover:bg-zinc-800"
                >
                  Send message
                </button>
              </form>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.35fr_0.65fr] lg:items-center lg:gap-12">
            ...
            <div className="rounded-3xl border border-white/40 bg-white p-6 shadow-[0_24px_56px_-32px_rgba(44,36,25,0.45)] sm:p-10">
              ...
              <div className="mt-5 space-y-4 text-sm leading-relaxed text-foreground/70">
                <p>
                  Olyahomes is built so guests can compare homes with confidence and hosts can
