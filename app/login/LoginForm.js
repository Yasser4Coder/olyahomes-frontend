...
export default function LoginForm() {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="mt-7 w-full rounded-xl bg-primary py-3.5 text-[15px] font-semibold text-white shadow-md shadow-primary/20 ring-1 ring-primary/15 transition hover:bg-primary/92 active:scale-[0.99]"
      >
        Continue
      </button>
