...
export const metadata = {
  ...
  description:
    "Terms governing your use of Olya Holiday Homes and our booking platform.",
};
...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 sm:py-16">
      <PageHeading
        title="Terms of service"
        subtitle="Rules for using Olya Holiday Homes. Please read them carefully."
      />
      ...
      <div className="space-y-10">
        <p className="text-sm leading-relaxed text-foreground/80">
          Welcome to <strong className="text-foreground/90">Olya Holiday Homes</strong>.
        ...
        <Section id="cancellation" title="4. Cancellation and refunds">
          <ul className="list-disc space-y-2 pl-5">
            <li>
              Cancellations and refunds follow the cancellation policy shown at the
              time of booking for that listing, unless otherwise required by law.
            </li>
            <li>
              Where a refund is due, it will generally be processed to the original
              payment method, subject to processing times of payment partners.
            </li>
            <li>
              Certain service or platform fees may be non-refundable as stated at checkout.
            </li>
          </ul>
        </Section>
        ...
        <Section id="liability" title="7. Limitation of liability">
          <p>
            To the fullest extent permitted by applicable law, Olya Holiday Homes and
